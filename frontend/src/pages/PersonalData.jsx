        ...
        {user && (
          ...
          >
            <div className="form-structure">
              <label htmlFor="grid-firstname">
                ...
                <input
                  ...
                  disabled={!editUser}
                  className={
                    !editUser ? "form-input bg-slate-300" : "form-input"
                  }
                />
              </label>
            ...
            {editUser === true ? (
              ...
              <button
                type="button"
                className="text-sm py-3 ml-2 mr-2 mb-12 mt-6 border-solid border-2 border-[#5f2525] text-[#5f2525] font-bold rounded focus:outline-none focus:shadow-outline"
                onClick={handleEdit}
              >
